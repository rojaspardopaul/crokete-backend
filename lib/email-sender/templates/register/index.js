...
>
  ...
  <body style="word-spacing:normal;background-color:#f2f3f8;">
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
        ...
        <tbody>
          <tr>
            <td>
              ...
              <div style="margin:20px auto 8px;max-width:600px;">
                <table
                  align="center"
                  border="0"
                  cellpadding="0"
                                      ...
                                      <tr>
                                        <td style="width:150px;">
                                          ...
                                          <img
                                            alt="Crokete Pet"
                                            height="auto"
                                            src="${CONFIG.CLOUDINARY.getImageUrl(CONFIG.CLOUDINARY.IMAGES.LOGO)}"
                                            style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:120px;font-size:13px;"
                                            width="120"
                                            height="80"
                                          />
                                        </td>
      ...
      <div
        class="body-section"
        style="margin: 0px auto; max-width: 600px; border-radius:0 0 8px 8px;overflow:hidden;"
      >
        <table
          align="center"
          cellpadding="0"
                ...
                >
                  ...
                  >
                    <tbody>
                      <tr>
                        <td
                          style="direction:ltr;font-size:0px;padding:0 0 10px;padding-left:15px;padding-right:15px;text-align:center;padding-top: 5px;"
                        >
                          ...
                          >
                            <!--start email_template -->
                            <h2 style="margin-top:1px;">Hola ${option.name}</h2>
                            <p>Verifica tu dirección de correo electrónico para completar el registro
                             e iniciar sesión en tu cuenta de 
                             <strong>Crokete Pet</strong>.
                            </p>

                            <p style="margin-bottom:30px;"> <p>Este enlace expirará en <strong>15 minutos</strong>.</p>

        <p style="margin-bottom:20px;">Haz clic en este enlace para activar tu cuenta</p></p>

                             <a href=${CONFIG.URLS.STORE}/auth/email-verification/${option.token} style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verificar Cuenta</a>

                            <p style="margin-top: 35px;">Si no iniciaste
                              esta solicitud, por favor contáctanos inmediatamente en
                              ${CONFIG.COMPANY.SUPPORT_EMAIL}</p>
                            ...
                            >Gracias
                              ...
                              >Equipo ${CONFIG.COMPANY.NAME}</h4></p>
      ...
      <div
        style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;border-radius:0 0 8px 8px;overflow:hidden;"
      >
        <table
          align="center"
          border="0"
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        Estás recibiendo este
                                                        correo porque te
                                                        registraste en ${CONFIG.COMPANY.NAME}
                                                        y aceptaste recibir
                                                        correos de nosotros sobre
                                                        nuevas características, eventos y
                                                        ofertas especiales.
                                                        <p
                                                        ...
                                                        >
                                                          &copy; ${CONFIG.COMPANY.NAME}, Todos los
