    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
      ...
      >
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            ...
                            <p>Verifica tu dirección de correo electrónico para completar el registro e iniciar sesión en tu cuenta de <strong>Crokete Pet</strong>.
                            </p>
        ...
        <p style="margin-bottom:20px;">Haz clic en este enlace para activar tu cuenta</p></p>
                             ...
                             <a href=${process.env.STORE_URL}/auth/email-verification/${option.token} style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verificar Cuenta</a>
