...
const loyaltyPointsEarnedEmail = (option) => {
  ...
  return (
    ...
    '<p style="margin:8px 0 0;font-size:14px;color:rgba(255,255,255,0.85);">Puntos de Recompensa</p>' +
    "</td></tr>" +
    // BODY
    ...
    '<p style="margin:0 0 6px;font-size:12px;color:rgba(255,255,255,0.7);line-height:1.5;">Eres parte de nuestro programa de lealtad.</p>' +
