                                      ...
                                      <tr>
                                        <td style='width:150px;'>
                                          ...
                                          <img
                                            ...
                                            style='border:0;display:block;outline:none;text-decoration:none;height:auto;width:150px;font-size:13px;padding-bottom:30px;'
                                            width="150"
                                            height="150"
                                          />
                                        </td>
                    ...
                    <tbody>
                      <tr>
                        ...
                        >
                          ...
                          >
                            <!--start email_template -->
 <h2>Hola ${option.name}</h2>
    <p>Se ha recibido una solicitud para agregarte como ${
      option.role === "admin" ? "administrador" : "miembro del equipo"
    } de <strong>Crokete Pet</strong>.</p>

      <p style="margin-bottom:30px;">Primero restablece tu contraseña haciendo clic en el botón de abajo. Después, podrás iniciar sesión en tu cuenta.</p>



      <a href=https://${option.cname}.app-dev.dashter.com/reset-password/${
    option.token
  }  style="background:#3b82f6;color:white;border:1px solid #3b82f6; padding: 10px 15px; margin-right: 20px; border-radius: 4px; text-decoration:none;">Restablecer Contraseña</a>  <a href="https://${
    option.cname
  }.app-dev.dashter.com/login"  style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Iniciar Sesión</a>
     ...
     <p style="margin:0px auto; margin-top:40px; text-align:center;">Gracias   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">Equipo ${CONFIG.COMPANY.NAME}</p></p>
                                                  ...
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        ...
                                                        correo porque te
                                                        registraste en
                                                        ${CONFIG.COMPANY.NAME} y aceptaste
                                                        recibir correos de nosotros
